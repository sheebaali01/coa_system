    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        <form method="POST" action="{{ route('admin.skus.add') }}">
            ...
            <div class="mb-8">
                ...
                <select name="unit_measure" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('admin.skus.index') }}" class="px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-50">
                    Cancel
                </a>
